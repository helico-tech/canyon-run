// Allocates the next CR-NNNN id and writes a story file. Usage:
...
export function createWorkItem({
  ...
  if (!/^EPIC-\d{2}$/.test(epic)) throw new Error(`epic must look like EPIC-01, got ${epic}`);
